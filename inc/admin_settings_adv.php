        ...
        <table id="key" class="form-table">
          <tr>
            ...
            <td>
              ...
              <p class="notes">
                <?php _e('<a href="https://criticalcss.com/account/api-keys" target="_blank">criticalcss.com</a> default viewport size is 1300x900 pixels (width x height). You can change this size by typing a desired width and height values above. Allowed values are 800 to 4096 for width, 600 to 2160 for height.', 'autoptimize'); ?>
              </p>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <p class="notes">
                <?php _e('<strong>CAUTION! DO NOT use debug mode on production/live environments.</strong><br />Check the box above to enable Autoptimize CriticalCSS Power-Up debug mode. It provides debug facilities in this screen, to <code>/wp-content/cache/ao_ccss/debug.log</code> file and to the browser console.', 'autoptimize'); ?>
              </p>
            </td>
          </tr>
        </table>
