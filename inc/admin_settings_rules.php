  ...
  <ul id="rules-panel">
    <li class="itemDetail">
      ...
      <div class="howto">
        ...
        <div class="howto-wrap hidden">
          ...
          <ol>
            ...
            <li><?php _e('Nonetheless, if you create a <span class="badge manual">MANUAL</span> for a path and leave its critical CSS content empty, the critical CSS for that path will be automatically fetched from <a href="https://criticalcss.com/?aff=1" target="_blank">criticalcss.com</a> for you. You can later edit it as you wish, as it will <strong>NEVER be updated again</strong> while that <span class="badge manual">MANUAL</span> exist.', 'autoptimize');?></li>
            <li><?php _e("If you see an <span class='badge auto'>AUTO</span> or <span class='badge manual'>MANUAL</span> rule with a <span class='badge review'>R</span> besides it (R is after REVIEW), it means that the fetched critical CSS for that rule is not 100% garanteed to work according to <a href='https://criticalcss.com/?aff=1' target='_blank'>criticalcss.com</a> analysis. It's advised that you edit and review that rule to make any required adjustments.", 'autoptimize');?></li>
      ...
      <p class="submit rules-btn">
        ...
        <span id="editDefaultButton" class="button-secondary"><?php _e('Add/Edit Edit Default Critical CSS', 'autoptimize'); ?></span>
        <span id="editAdditionalButton" class="button-secondary"><?php _e('Add/Edit Additional Critical CSS', 'autoptimize'); ?></span>
      </p>
      <!-- END Rules UI -->
