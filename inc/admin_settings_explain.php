...
function ao_ccss_render_explain() {
    ...
    <ul id="explain-panel">
        <li class="itemDetail">
            ...
            <div><p><?php _e('The next step is to sign up at ','autoptimize'); ?><a href="https://criticalcss.com/?aff=1" target="_blank">https://criticalcss.com</a><strong><?php _e(' and get the API key, which you can copy from ','autoptimize'); ?><a href="https://criticalcss.com/account/api-keys?aff=1" target="_blank"><?php _e('the API-keys page','autoptimize'); ?></a></strong> <?php _e('and paste below.','autoptimize'); ?></p></div>
            <div><p><?php _e('If you have any questions or need support, head on over to','autoptimize'); ?> <a href="https://wordpress.org/support/plugin/autoptimize-criticalcss" target="_blank">our support forum</a> <?php _e('and we\'ll help you get up and running in no time! ','autoptimize'); ?></p></div>
        </li>
    </ul>
    <?php
}
