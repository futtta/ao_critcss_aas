        ...
        <table id="key" class="form-table">
          <tr>
            ...
            <td>
              ...
              <p class="notes">
                <?php _e('Enter your <a href="https://criticalcss.com/account/api-keys?aff=1" target="_blank">criticalcss.com</a> API key above. The key is revalidated every time a new job is sent to it.<br />To obtain your API key, go to <a href="https://criticalcss.com/account/api-keys?aff=1" target="_blank">criticalcss.com</a> > Account > API Keys.<br /><strong>Requests to generate a critical CSS via the API are priced at £5 per domain per month.</strong>', 'autoptimize'); ?>
              </p>
            </td>
          </tr>
        </table>
