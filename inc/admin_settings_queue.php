      ...
      <div class="howto">
        ...
        <div class="howto-wrap hidden">
          ...
          <ol>
            ...
            <li><?php _e('As soon as <a href="https://criticalcss.com/?aff=1" target="_blank">criticalcss.com</a> returns a valid critical CSS file, the job is then <span class="badge done">D</span>. You can delete done jobs as you wish.', 'autoptimize');?></li>
            <li><?php _e('If <a href="https://criticalcss.com/?aff=1" target="_blank">criticalcss.com</a> results are not perfect, then the job becomes <span class="badge review">R</span> and you need to review the resulting critical CSS file fetched in the target rule pointed out by that job.', 'autoptimize');?></li>
