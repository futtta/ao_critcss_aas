      ...
      <div class="howto">
        ...
        <div class="howto-wrap hidden">
          ...
          <ol>
            ...
            <li><?php _e('When the conditions to create a rule are met (i.e. user not logged in, no matching <span class="badge manual">MANUAL</span> rule, changed CSS files for an <span class="badge auto">AUTO</span> rule), a <span class="badge new">N</span> job is created in the queue.', 'autoptimize');?></li>
