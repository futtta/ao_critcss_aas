    ...
    <li class="itemDetail">
      ...
      <div class="howto">
        ...
        <div class="howto-wrap hidden">
          ...
          <ol>
            <li><?php _e('The queue operates <strong>automatically, asynchronously and on regular intervals.</strong>', 'autoptimize');?></li>
            <li><?php _e('When the conditions to create a rule are met (i.e. user not logged in, page type not matching a <span class="badge manual">MANUAL</span> rule), a <span class="badge new">N</span> job is created in the queue.', 'autoptimize');?></li>
