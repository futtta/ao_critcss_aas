    ...
    <li class="itemDetail">
      ...
      <div class="howto">
        ...
        <div class="howto-wrap hidden">
          <p><?php _e('TL;DR:<br />Job statuses are <span class="badge new">N</span> for NEW, <span class="badge pending">P</span> for PENDING, <span class="badge done">D</span> for DONE, <span class="badge review">R</span> for REVIEW, <span class="badge error">E</span> for ERROR and <span class="badge unknown">U</span> for UNKOWN.', 'autoptimize');?></p>
          <ol>
            <li><?php _e('The queue operates <strong>automatically, asynchronously and on regular intervals.</strong> To view updated queue status, refresh this page.', 'autoptimize');?></li>
            <li><?php _e('When the conditions to create a rule are met (i.e. user not logged in, no matching <span class="badge manual">MANUAL</span> rule), a <span class="badge new">N</span> job is created in the queue.', 'autoptimize');?></li>
            ...
            <li><?php _e('As soon as <a href="https://criticalcss.com/" target="_blank">criticalcss.com</a> returns a reliable critical CSS file, the job is then <span class="badge done">D</span>. You can delete done jobs as you wish.', 'autoptimize');?></li>
            <li><?php _e('If <a href="https://criticalcss.com/" target="_blank">criticalcss.com</a> results are not perfect, then the job becomes <span class="badge review">R</span> and you need to review the resulting critical CSS file fetched. If you aprove it, you get a rule. If not, then it is going to be marked as <span class="badge error">E</span> and never run again unless you say so.', 'autoptimize');?></li>
            <li><?php _e('When things go bad, a job is marked as <span class="badge error">E</span>. You can retry faulty jobs or get in touch with <a href="https://criticalcss.com/" target="_blank">criticalcss.com</a> for assistance.', 'autoptimize');?></li>
            <li><?php _e('Sometimes an unknown condition can happen. In this case, the job status becomes <span class="badge unknown">U</span> and you may want to ask <a href="https://criticalcss.com/" target="_blank">criticalcss.com</a> for help.', 'autoptimize');?></li>
